 ...
 * @author SAMEER
 */
public class EditPurchaseInformation extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddCash
     */
    public EditPurchaseInformation() {
        initComponents();
        show_cash();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Purchase Details");
    ...
    public ArrayList<PurchaseModel>getCashList()
    {
        ArrayList<PurchaseModel>cashList=new ArrayList<PurchaseModel>();
        ...
        try{
            ...
            while(rs.next())
            {
                //cash = new PurchaseModel(rs.getInt("id"),rs.getString("name"),rs.getString("mno"),rs.getString("address"),rs.getString("email"),rs.getString("password"));
               //cashList.add(cash);
            }
 ...
 // Display data in JTable
    ...
    {
        ArrayList<PurchaseModel> list=getCashList();
